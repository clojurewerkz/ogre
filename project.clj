(defproject clojurewerkz/ogre "3.4.3.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.9.0"]
                 [potemkin "0.4.4"]
                 [org.apache.tinkerpop/gremlin-core "3.4.3-SNAPSHOT"]]
  :source-paths ["src/clojure"]
  :profiles {:dev {:global-vars {*assert* true}
                   :dependencies [[clojurewerkz/support "1.1.0" :exclusions [org.clojure/clojure]]
                                  [commons-io/commons-io "2.6"]
                                  [org.apache.tinkerpop/gremlin-test "3.4.3-SNAPSHOT"  :scope "test"]
                                  [org.apache.tinkerpop/tinkergraph-gremlin "3.4.3-SNAPSHOT" :scope "test"]
