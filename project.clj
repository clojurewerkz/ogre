(defproject clojurewerkz/ogre "3.4.0.0-SNAPSHOT"
  ...
  :profiles {:dev {:global-vars {*assert* true}
                   :dependencies [[clojurewerkz/support "1.1.0" :exclusions [org.clojure/clojure]]
                                  ...
                                  [org.apache.tinkerpop/gremlin-test "3.4.0"  :scope "test"]
                                  [org.apache.tinkerpop/tinkergraph-gremlin "3.4.0" :scope "test"]
